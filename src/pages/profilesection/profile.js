    ...
    <div className="drawer_1">
      <Box sx={{ display: "flex" }}>
        ...
        >
          ...
          <Box>
            <Box className="fh_startsale">Profile Setting</Box>
            <Box className="sh_startsale">Allow Notification and Setting</Box>
          </Box>
          <Box className="th_startsale">Profile </Box>
          <Box className="border_1">
            <Box className="psborder_12">
          ...
          <div className="logo_every_pagepp">
